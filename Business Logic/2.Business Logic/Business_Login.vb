...
Public Class Business_Login
    ...
    End Sub
    Friend Sub Login()
        Dim Request As FW_BaseRequestBasicAuthentication = RequestDTO
        Dim Response As New FW_BaseResponseTokenInformation
        Dim ResponseService As FrameWork.FW_ResponseService
        ResponseService = Gestores.Seguridad.AutenticacionBasica(Request.Username, Request.Password)
        Response.SetData(ResponseService.Data)
        SetResponse(Response)
    End Sub
End Class
