...
Public Class Transaction_Login
    ...
    Public Sub Login()
        Try
            InicializarTransaccion("Autenticacion simple")
            Business.Login.Login()
            FinalizarTransaccion()
        Catch ex As Exception
            Exception(ex, DiccionarioMensajes(Enum_Messages.Void))
        End Try
    End Sub
    Public Sub ObtenerSocialLogin()
        Try
            ...
            FinalizarTransaccion()
        Catch ex As Exception
            Exception(ex, DiccionarioMensajes(""))
        End Try
    End Sub
